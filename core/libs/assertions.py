...
def validation_assert(error_code, msg):
...
def assert_valid(cond, client_validation=False, msg='BAD_REQUEST'):
    if cond is False:
        if client_validation is True:
            validation_assert(400, msg)
        base_assert(400, msg)
